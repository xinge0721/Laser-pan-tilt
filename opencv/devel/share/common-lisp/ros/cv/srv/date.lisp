...
(cl:defmethod cl:initialize-instance :after ((m <date-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'date-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cv-srv:<date-request> is deprecated: use cv-srv:date-request instead.")))

(cl:ensure-generic-function 'mood-val :lambda-list '(m))
(cl:defmethod mood-val ((m <date-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv-srv:mood-val is deprecated.  Use cv-srv:mood instead.")
  (mood m))
...
(cl:defmethod cl:initialize-instance :after ((m <date-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'date-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cv-srv:<date-response> is deprecated: use cv-srv:date-response instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <date-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv-srv:x-val is deprecated.  Use cv-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <date-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv-srv:y-val is deprecated.  Use cv-srv:y instead.")
  (y m))
